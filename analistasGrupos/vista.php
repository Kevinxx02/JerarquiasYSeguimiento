...
<html lang="en">
  <head>
    ...
    <title>Analistas Grupos</title>
    <link rel="stylesheet" href="estilos.css?123213">
  ...
  <body class="hold-transition layout-top-nav">  
    <div class="content-wrapper">
        <div class="content-header" style="margin:0px; padding:0px;">
            <div class="row mb-2" style="width:99%; margin:0px; padding:0px;">
                <div class="col-sm-6">
                    <span class="text-left" style="padding-left:20px; color:#059;font-weight:600; margin-top:7px;font-size:larger"> Analistas Grupos </span>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right mr-4" style="font-size:12px; padding-top:8px;">
                    <li class="breadcrumb-item"><a href="../../../index.php" target="_parent">Inicio</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo basename(__FILE__) ?>">Analistas Grupos</a></li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    <button type="button" title="Registrar" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal">
                        <i class="material-icons" title="Registrar"  style="font-size: 15px; margin-top:3px;">library_add</i>
                        Crear grupo
                    </button>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">   
                        <table id="tablaDatos" class="table table-striped table-bordered table-condensed table-hover" style="width:100%;font-size:13px;">
